...
\033[1;35m│ [✓] WHATSAPP :  018---******        │
\033[1;36m│ [✓] ARIYA  : \x1b[1;32mPRO PRONOY\x1b[1;97m           │
\033[1;32m└───────────────────────────────────────┘  
         \033[41m\033[1;37m𝐓𝐎𝐎𝐋 𝐀𝐃𝐌𝐈𝐍 [Ariyan] [pÏඋඋħÏ]\x1b[0m    
 """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [Ariyan] : %s/%s -> \033[0;92m [ SABIR-OK:%s ]- \033[0;91m[SABIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
